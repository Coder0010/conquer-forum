@isActive
    ...
    @if ($_permission || $_role)
        <a class='edit_btn btn btn-sm btn-clean btn-icon border border-dark' onclick='{{ $buttonOnclickFunction }}' data-tooltip='kt-tooltip' data-original-title='{{ __('main.edit') }}'>
