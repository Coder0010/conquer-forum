...
@section("content")
    ...
    <div class="d-flex flex-column flex-root">
        <!--begin::Login-->
        <div id="kt_login" class="login login-4 login-forgot-on d-flex flex-row-fluid">
            <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url({{ asset('adminpanel/assets/media/bg/bg-3.jpg') }});">
                <div class="login-form text-center p-7 position-relative overflow-hidden">
                    ...
                    <!--end::Login Header-->
                    @include("auths::adminpanel.auth.forms.login-form")
                    @include("auths::adminpanel.auth.forms.forget-form")
                </div>
            </div>
        </div>
        <!--end::Login-->
